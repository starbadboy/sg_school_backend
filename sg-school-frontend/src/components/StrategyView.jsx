            ...
            <div key={index} className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-200 hover:border-blue-300 transition-colors">
              ...
              <div className="text-right space-y-1">
                ...
                <div className="text-xs text-slate-500">
                  {school.p1_data?.total_vacancies} places available
                </div>
              </div>
            </div>
          ))}
            ...
            <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200">
              <ReactMarkdown 
                ...
                components={{
                  ...
                  h1: ({node, ...props}) => <h1 className="text-2xl font-bold text-slate-900 mb-4 mt-6 first:mt-0" {...props} />,
                  h2: ({node, ...props}) => <h2 className="text-xl font-bold text-slate-900 mb-3 mt-5 first:mt-0" {...props} />,
                  h3: ({node, ...props}) => <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-4 first:mt-0" {...props} />,
                  ...
                  ul: ({node, ...props}) => <ul className="mb-4 pl-5 space-y-1" {...props} />,
                  ol: ({node, ...props}) => <ol className="mb-4 pl-5 space-y-1" {...props} />,
                  li: ({node, ...props}) => <li className="text-slate-700" {...props} />,
                  strong: ({node, ...props}) => <strong className="font-semibold text-slate-900" {...props} />,
                  em: ({node, ...props}) => <em className="italic text-slate-800" {...props} />,
                  blockquote: ({node, ...props}) => <blockquote className="border-l-4 border-blue-200 pl-4 italic text-slate-600 my-4" {...props} />,
                  ...
                  code: ({node, inline, ...props}) => 
                    inline 
                      ...
                      : <code className="block bg-slate-100 text-slate-800 p-4 rounded-lg text-sm overflow-x-auto" {...props} />,
                  // Table styling
                  ...
                  th: ({node, ...props}) => <th className="px-4 py-3 text-left font-semibold text-slate-900 border border-slate-300" {...props} />,
                  td: ({node, ...props}) => <td className="px-4 py-3 text-slate-700 border border-slate-300 align-top" {...props} />
                }}
              >
                {strategy}
              </ReactMarkdown>
